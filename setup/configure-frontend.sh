...
ID_Benutzer=$(grep "^Benutzer=" "$IDS_FILE" | cut -d= -f2)
ID_Changelog=$(grep "^Changelog=" "$IDS_FILE" | cut -d= -f2)
...
echo "   Benutzer:             $ID_Benutzer"
echo "   Changelog:            $ID_Changelog"
